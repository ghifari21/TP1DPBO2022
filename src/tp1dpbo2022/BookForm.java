...
public class BookForm extends javax.swing.JFrame {
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        ...
        if (penerbit.length() == 0 || author.length() == 0 || deskripsi.length() == 0 || urlImg.length() == 0) {
            ...
            try {
                String sql = "INSERT INTO `tbooks` (`id`, `img`, `penerbit`, `author`, `deskripsi`) VALUES (null, '"+dataBuku.getImg()+"', '"+dataBuku.getPenerbit()+"', '"+dataBuku.getAuthor()+"', '"+dataBuku.getDeskripsi()+"');";
                db.Query(sql);
            }catch(Exception e) {
